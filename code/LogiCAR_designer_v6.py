...
python LogiCAR_designer_v6.py -i1 ../../02.Input/EMTAB8107/EMTAB8107_LogiCAR.txt -i2 ../../02.Input/Tabula_Sapiens/Tabula_Sapiens_subsampled_matrix.csv -g ../../02.Input/Constants/intersection_and_clinical.txt -o ./output/BRCA_EMTAB8107_optimal_triplets_AA.txt -N 200 -c A -mp 0.2 -cp 0.5 -r 1
python LogiCAR_designer_v6.py -i1 ../../02.Input/GSE176078/GSE176078_LogiCAR.txt -i2 ../../02.Input/Tabula_Sapiens/Tabula_Sapiens_subsampled_matrix.csv -g ../../02.Input/Constants/intersection_and_clinical.txt -o ./output/BRCA_GSE176078_optimal_triplets_AA.txt -N 200 -c A -mp 0.2 -cp 0.5 -r 1

python LogiCAR_designer_v6.py -i1 ../../02.Input/EMTAB8107/EMTAB8107_LogiCAR.txt -i2 ../../02.Input/Tabula_Sapiens/Tabula_Sapiens_subsampled_matrix.csv -g ../../02.Input/Constants/intersection_and_clinical.txt -o ./output/BRCA_EMTAB8107_optimal_triplets_AA.txt -N 200 -c AA -mp 0.2 -cp 0.5 -r 1

python LogiCAR_designer_v6.py -i1 ../../02.Input/GSE118389/GSE118389_LogiCAR.txt -i2 ../../02.Input/Tabula_Sapiens/Tabula_Sapiens_subsampled_matrix.csv -g ../../02.Input/Constants/intersection_and_clinical.txt -o ./output/BRCA_GSE118389_optimal_triplets_AA.txt -N 200 -c AA -mp 0.2 -cp 0.5 -r 1

python LogiCAR_designer_v6.py -i1 ../../02.Input/Stefan_snRNAseq/Stefan_snRNAseq_LogiCAR.txt -i2 ../../02.Input/Tabula_Sapiens/Tabula_Sapiens_subsampled_matrix.csv -g ../../02.Input/Constants/intersection_and_clinical.txt -o ./output/BRCA_Stefan_snRNAseq_optimal_doublets_A.txt -N 200 -c A -mp 0.2 -cp 0.5 -r 1
python LogiCAR_designer_v6.py -i1 ../../02.Input/Stefan_snRNAseq/Stefan_snRNAseq_LogiCAR.txt -i2 ../../02.Input/Tabula_Sapiens/Tabula_Sapiens_subsampled_matrix.csv -g ../../02.Input/Constants/intersection_and_clinical.txt -o ./output/BRCA_Stefan_snRNAseq_optimal_doublets_O.txt -N 200 -c O -mp 0.2 -cp 0.5 -r 1
python LogiCAR_designer_v6.py -i1 ../../02.Input/Stefan_snRNAseq/Stefan_snRNAseq_LogiCAR.txt -i2 ../../02.Input/Tabula_Sapiens/Tabula_Sapiens_subsampled_matrix.csv -g ../../02.Input/Constants/intersection_and_clinical.txt -o ./output/BRCA_Stefan_snRNAseq_optimal_triplets_AA.txt -N 200 -c AA -mp 0.2 -cp 0.5 -r 1
python LogiCAR_designer_v6.py -i1 ../../02.Input/Stefan_snRNAseq/Stefan_snRNAseq_LogiCAR.txt -i2 ../../02.Input/Tabula_Sapiens/Tabula_Sapiens_subsampled_matrix.csv -g ../../02.Input/Constants/intersection_and_clinical.txt -o ./output/BRCA_Stefan_snRNAseq_optimal_triplets_AO.txt -N 200 -c AO -mp 0.2 -cp 0.5 -r 1
python LogiCAR_designer_v6.py -i1 ../../02.Input/Stefan_snRNAseq/Stefan_snRNAseq_LogiCAR.txt -i2 ../../02.Input/Tabula_Sapiens/Tabula_Sapiens_subsampled_matrix.csv -g ../../02.Input/Constants/intersection_and_clinical.txt -o ./output/BRCA_Stefan_snRNAseq_optimal_triplets_OA.txt -N 200 -c OA -mp 0.2 -cp 0.5 -r 1
python LogiCAR_designer_v6.py -i1 ../../02.Input/Stefan_snRNAseq/Stefan_snRNAseq_LogiCAR.txt -i2 ../../02.Input/Tabula_Sapiens/Tabula_Sapiens_subsampled_matrix.csv -g ../../02.Input/Constants/intersection_and_clinical.txt -o ./output/BRCA_Stefan_snRNAseq_optimal_triplets_OO.txt -N 200 -c OO -mp 0.2 -cp 0.5 -r 1

## Stefan TNBC
python LogiCAR_designer_v6.py -i1 ../../02.Input/Stefan_snRNAseq/Stefan_83snRNAseq_LogiCAR_wgene_and_clinical_TNBC_tumorOnly.txt -i2 ../../02.Input/Tabula_Sapiens/Tabula_Sapiens_subsampled_matrix.csv -g ../../02.Input/Constants/intersection_and_clinical.txt -o ./output/BRCA_Stefan_snRNAseq_TNBC_optimal_triplets_AA.txt -N 200 -c AA -mp 0.2 -cp 0.5 -r 1
python LogiCAR_designer_v6.py -i1 ../../02.Input/Stefan_snRNAseq/Stefan_83snRNAseq_LogiCAR_wgene_and_clinical_TNBC_tumorOnly.txt -i2 ../../02.Input/Tabula_Sapiens/Tabula_Sapiens_subsampled_matrix.csv -g ../../02.Input/Constants/intersection_and_clinical.txt -o ./output/BRCA_Stefan_snRNAseq_TNBC_optimal_triplets_AO.txt -N 200 -c AO -mp 0.2 -cp 0.5 -r 1
python LogiCAR_designer_v6.py -i1 ../../02.Input/Stefan_snRNAseq/Stefan_83snRNAseq_LogiCAR_wgene_and_clinical_TNBC_tumorOnly.txt -i2 ../../02.Input/Tabula_Sapiens/Tabula_Sapiens_subsampled_matrix.csv -g ../../02.Input/Constants/intersection_and_clinical.txt -o ./output/BRCA_Stefan_snRNAseq_TNBC_optimal_triplets_OA.txt -N 200 -c OA -mp 0.2 -cp 0.5 -r 1
python LogiCAR_designer_v6.py -i1 ../../02.Input/Stefan_snRNAseq/Stefan_83snRNAseq_LogiCAR_wgene_and_clinical_TNBC_tumorOnly.txt -i2 ../../02.Input/Tabula_Sapiens/Tabula_Sapiens_subsampled_matrix.csv -g ../../02.Input/Constants/intersection_and_clinical.txt -o ./output/BRCA_Stefan_snRNAseq_TNBC_optimal_triplets_OO.txt -N 200 -c OO -mp 0.2 -cp 0.5 -r 1

## GSE161529_patient0135 single patient
python LogiCAR_designer_v6.py -i1 ../../02.Input/GSE161529/GSE161529_LogiCAR_wgene_and_clinical_patient0135_tumorOnly.txt -i2 ../../02.Input/Tabula_Sapiens/Tabula_Sapiens_subsampled_matrix.csv -g ../../02.Input/Constants/intersection_and_clinical.txt -o ./output/BRCA_GSE161529_patient0135_optimal_triplets_AA.txt -N 200 -c AA -mp 0.2 -cp 0.5 -r 1
python LogiCAR_designer_v6.py -i1 ../../02.Input/GSE161529/GSE161529_LogiCAR_wgene_and_clinical_patient0135_tumorOnly.txt -i2 ../../02.Input/Tabula_Sapiens/Tabula_Sapiens_subsampled_matrix.csv -g ../../02.Input/Constants/intersection_and_clinical.txt -o ./output/BRCA_GSE161529_patient0135_optimal_triplets_AO.txt -N 200 -c AO -mp 0.2 -cp 0.5 -r 1
python LogiCAR_designer_v6.py -i1 ../../02.Input/GSE161529/GSE161529_LogiCAR_wgene_and_clinical_patient0135_tumorOnly.txt -i2 ../../02.Input/Tabula_Sapiens/Tabula_Sapiens_subsampled_matrix.csv -g ../../02.Input/Constants/intersection_and_clinical.txt -o ./output/BRCA_GSE161529_patient0135_optimal_triplets_OA.txt -N 200 -c OA -mp 0.2 -cp 0.5 -r 1
python LogiCAR_designer_v6.py -i1 ../../02.Input/GSE161529/GSE161529_LogiCAR_wgene_and_clinical_patient0135_tumorOnly.txt -i2 ../../02.Input/Tabula_Sapiens/Tabula_Sapiens_subsampled_matrix.csv -g ../../02.Input/Constants/intersection_and_clinical.txt -o ./output/BRCA_GSE161529_patient0135_optimal_triplets_OO.txt -N 200 -c OO -mp 0.2 -cp 0.5 -r 1

## all datasets all patients
# 3-gene
...
python LogiCAR_designer_v6.py -i1 ../../02.Input/15BRCAdatasets_tumorCells_LogiCAR_wgene_and_clinical.txt -i2 ../../02.Input/HPA/version24_20241022/rna/HPA_LogiCAR_cell_surface_genes_wgene_and_clinical.txt -g ../../02.Input/Constants/cell_surface_genes_wgene_and_clinical_uniqueStandardNames.txt -o ./output/BRCA_AllDatasets_all_optimal_triplets_AO.txt -N 200 -c AO -mp 0.2 -cp 0.5 -r 1
python LogiCAR_designer_v6.py -i1 ../../02.Input/15BRCAdatasets_tumorCells_LogiCAR_wgene_and_clinical.txt -i2 ../../02.Input/HPA/version24_20241022/rna/HPA_LogiCAR_cell_surface_genes_wgene_and_clinical.txt -g ../../02.Input/Constants/cell_surface_genes_wgene_and_clinical_uniqueStandardNames.txt -o ./output/BRCA_AllDatasets_all_optimal_triplets_OA.txt -N 200 -c OA -mp 0.2 -cp 0.5 -r 1
python LogiCAR_designer_v6.py -i1 ../../02.Input/15BRCAdatasets_tumorCells_LogiCAR_wgene_and_clinical.txt -i2 ../../02.Input/HPA/version24_20241022/rna/HPA_LogiCAR_cell_surface_genes_wgene_and_clinical.txt -g ../../02.Input/Constants/cell_surface_genes_wgene_and_clinical_uniqueStandardNames.txt -o ./output/BRCA_AllDatasets_all_optimal_triplets_OO.txt -N 200 -c OO -mp 0.2 -cp 0.5 -r 1
# 2-gene
python LogiCAR_designer_v6.py -i1 ../../02.Input/15BRCAdatasets_tumorCells_LogiCAR_wgene_and_clinical.txt -i2 ../../02.Input/HPA/version24_20241022/rna/HPA_LogiCAR_cell_surface_genes_wgene_and_clinical.txt -g ../../02.Input/Constants/cell_surface_genes_wgene_and_clinical_uniqueStandardNames.txt -o ./output/BRCA_AllDatasets_all_optimal_triplets_A.txt -N 200 -c A -mp 0.2 -cp 0.5 -r 1
python LogiCAR_designer_v6.py -i1 ../../02.Input/15BRCAdatasets_tumorCells_LogiCAR_wgene_and_clinical.txt -i2 ../../02.Input/HPA/version24_20241022/rna/HPA_LogiCAR_cell_surface_genes_wgene_and_clinical.txt -g ../../02.Input/Constants/cell_surface_genes_wgene_and_clinical_uniqueStandardNames.txt -o ./output/BRCA_AllDatasets_all_optimal_triplets_O.txt -N 200 -c O -mp 0.2 -cp 0.5 -r 1

# 5-gene
python LogiCAR_designer_v6.py -i1 ../../02.Input/15BRCAdatasets_tumorCells_LogiCAR_wgene_and_clinical.txt -i2 ../../02.Input/HPA/version24_20241022/rna/HPA_LogiCAR_cell_surface_genes_wgene_and_clinical.txt -g ../../02.Input/Constants/cell_surface_genes_wgene_and_clinical_uniqueStandardNames.txt -o ./output/BRCA_AllDatasets_all_optimal_triplets_OA_O_O.txt -N 200 -c OA_O_O -mp 0.2 -cp 0.5 -r 1
python LogiCAR_designer_v6.py -i1 ../../02.Input/15BRCAdatasets_tumorCells_LogiCAR_wgene_and_clinical.txt -i2 ../../02.Input/HPA/version24_20241022/rna/HPA_LogiCAR_cell_surface_genes_wgene_and_clinical.txt -g ../../02.Input/Constants/cell_surface_genes_wgene_and_clinical_uniqueStandardNames.txt -o ./output/BRCA_AllDatasets_all_optimal_triplets_OO_A_A.txt -N 200 -c OO_A_A -mp 0.2 -cp 0.5 -r 1
