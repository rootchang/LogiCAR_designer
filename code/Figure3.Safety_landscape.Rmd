---
title: "Evaluate the safety and efficacy of potential CARs and logic-gated CARs across datasets"
...
# local
HPA_data_dir_RNA = "/Users/changt7/Documents/00.PostDocWork/CancerResearch/01.Projects/00.Collaborating_projects/08.Sanna_CART/02.Input/HPA/version24_20241022/rna/"
HPA_data_dir_protein = "/Users/changt7/Documents/00.PostDocWork/CancerResearch/01.Projects/00.Collaborating_projects/08.Sanna_CART/02.Input/HPA/version24_20241022/protein/"

# server
# HPA_data_dir_RNA = "/data/Lab_ruppin/tiangen/CancerProject/08.Sanna_CART/02.Input/HPA/version24_20241022/"
# HPA_data_dir_protein = "/data/Lab_ruppin/tiangen/CancerProject/08.Sanna_CART/02.Input/HPA/version24_20241022/"
...
length(allGenes_HPA_protein) # 11141 without uncertain proteins; 13463 with uncertain proteins
...
#unique(seu_HPA_RNA$Tissue_grouped)
#unique(seu_HPA_RNA$cell_group_custom) # remove Unspecified and Mixed
...
save(candidateCARs_equivalent_RNA_Expression_res_df, file = "/Users/changt7/Documents/00.PostDocWork/CancerResearch/01.Projects/00.Collaborating_projects/08.Sanna_CART/02.Input/HPA/version24_20241022/rna/candidateCARs_77_equivalent_RNA_Expression_res_df_v2.rdata")
...
setdiff(candidateCARs_equivalent_RNA_Expression_res_df$cell_group_custom, cells_reordered)
setdiff(cells_reordered, candidateCARs_equivalent_RNA_Expression_res_df$cell_group_custom)
...
setdiff(candidateCARs_equivalent_RNA_Expression_res_df$Tissue_grouped, tissues_reordered)
setdiff(tissues_reordered, candidateCARs_equivalent_RNA_Expression_res_df$Tissue_grouped)
...
ggplot(plot_data, aes(x = Tissue_grouped, y = Gene)) +
  ...
  scale_color_gradientn(
    colors = c("#440154", "#31688E", "#35B779", "#FDE725"), # Define the four colors : "white", "lightgray", "darkgray", "black"   "#B0B0B0", "#F4A6A6", "#E53935", "#A31D1D".  "green", "yellow", "orange", "red".   "blue", "cyan", "yellow", "red".    "#440154", "#31688E", "#35B779", "#FDE725"
  ...
  theme(panel.grid = element_blank(), 
        ...
        legend.position = "right" # right none
        )
dev.off()
...
save(candidateCARs_equivalent_Protein_Expression_res_df_Tissues, file = "/Users/changt7/Documents/00.PostDocWork/CancerResearch/01.Projects/00.Collaborating_projects/08.Sanna_CART/02.Input/HPA/version24_20241022/rna/candidateCARs_77_equivalent_Protein_Expression_res_df_Tissues_v2.rdata")
...
setdiff(candidateCARs_equivalent_Protein_Expression_res_df_Tissues$Tissue_grouped, tissues_reordered)
setdiff(tissues_reordered, candidateCARs_equivalent_Protein_Expression_res_df_Tissues$Tissue_grouped)
...
save(candidateCARs_equivalent_Protein_Expression_res_df_Cells, file = "/Users/changt7/Documents/00.PostDocWork/CancerResearch/01.Projects/00.Collaborating_projects/08.Sanna_CART/02.Input/HPA/version24_20241022/rna/candidateCARs_77_equivalent_Protein_Expression_res_df_Cells_v2.rdata")
...
setdiff(candidateCARs_equivalent_Protein_Expression_res_df_Cells$Cell_grouped, Cells_reordered)
setdiff(Cells_reordered, candidateCARs_equivalent_Protein_Expression_res_df_Cells$Cell_grouped)
...
# Figure 3b. (must run Figure 3a first to prepare the params.) grid plot showing mean safety score of candidate CARs (4 groups)
```{r}
...
# Create the plot
pdf_file <- paste0(fig_dir, "Figure3b_safety_landscape_RNA_and_Protein.pdf")
fig_width <- 16
fig_height <- 3.8
fontSize <- 10 # Larger font size for axis tick labels
pdf(pdf_file, onefile = FALSE, width = fig_width, height = fig_height)
